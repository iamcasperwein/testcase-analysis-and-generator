...
const buildTestCaseGenerationPrompt = (input = {}) => {
    ...
    lines.push(
        ...
        "1. Environment:  \"Environment: staging\"",
        "   → Override to \"Environment: production\" ONLY if this specific test case explicitly requires it.",
        ...
        ...(pageMappingContext ? [
            ...
            "- Non-navigation preconditions (login state, data setup, feature flags, environment state) — plain strings, no annotation needed.",
            "",
            "Steps:",
    ...
    const logSegments = [
        ...
        logSegment("Rules & Instructions", [
            ...
            "--- Rules ---",
            "- Return valid JSON only.",
            `- Precondition Context Rules (Environment, Locale, Account order enforced)`,
