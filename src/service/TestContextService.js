...
const buildPromptContext = (products = []) => {
    ...
    const lines = [
        ...
        `- Write as precondition: \`"Environment: ${defaultServer}"\``,
        "- Only override to `\"Environment: production\"` when the test case or source documents explicitly require production data or production-only behaviour. Treat production as an exception, not the default.",
        "",
        "### 2. Locale",
